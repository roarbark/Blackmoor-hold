...
/datum/skill/combat/proc/get_firearm_accident_chance_modifier(level) //supposed to calculate firearms incident changes, not sure if this one is working correctly
	switch(level)
		if(SKILL_LEVEL_NONE)
			return 80
